...
namespace spicyisti\spicer\fields;

use spicyisti\spicer\Spicer;
use spicyisti\spicer\assetbundles\spicerfieldfield\SpicerFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class SpicerField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('spicer', 'SpicerField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'spicer/_components/fields/SpicerField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SpicerFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SpicerSpicerField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'spicer/_components/fields/SpicerField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
